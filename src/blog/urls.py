...
from blog.views import post_list, post_retrieve, post_share, PostListView, experiments, PostListBySearch
...
urlpatterns = [
    ...
    path('search/', PostListBySearch.as_view(), name='list_by_search'),
